...
function About () {
    return(
        ...
        <>
        <container className="grid grid-flow-row grid-cols-2 grid-rows-3">

                <img className="h-auto max-w-40" src="src/assets/selfie.jpg" alt="selfie" />
                <p className="max-w-max min-w max">
